...
const F = {
  ...
  dec: { y: 839, xs: [121, 164, 207, 250, 290, 329, 368] },
  totalGain: { x: 494, y: 814, w: 104 },
  totalRet: { x: 606, y: 814, w: 94 },
  net: { x: 494, y: 840, w: 206 },
  cumuls: { y: 929, xs: [3, 95, 260, 411, 552], ws: [92, 165, 151, 141, 155] },
};
