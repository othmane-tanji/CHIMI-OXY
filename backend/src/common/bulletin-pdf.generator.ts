...
const F = {
  cnss: { x: 104, y: 83 },
  periodeDu: { x: 509, y: 121, w: 89 },
  periodeAu: { x: 627, y: 121, w: 88 },
  matricule: { x: 3, y: 211, w: 77 },
  nom: { x: 91, y: 211 },
  fonction: { x: 356, y: 211, w: 202 },
  paie1: { x: 558, y: 211, w: 35 },
  depart: { x: 593, y: 211, w: 42 },
  sect: { x: 635, y: 211, w: 45 },
  categ: { x: 680, y: 211, w: 42 },
  adresse: { x: 68, y: 249 },
  ...
  dec: { y: 839, xs: [114, 155, 190, 226, 261, 287, 313] },
  totalGain: { x: 494, y: 814, w: 120 },
  totalRet: { x: 614, y: 814, w: 108 },
  net: { x: 494, y: 840, w: 228 },
  cumuls: { y: 929, xs: [3, 95, 260, 411, 552], ws: [92, 165, 151, 141, 170] },
};
