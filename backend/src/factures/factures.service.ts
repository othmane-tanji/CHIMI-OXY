  ...
  async createVente(dto: CreateFactureVenteDto) {
    ...
    const facture = await this.prisma.factureVente.create({
      data: {
        ...
        numeroBl: dto.numeroBl || numeroFacture,
        delaiPaiement: dto.delaiPaiement || dto.conditionPaiement || '60 JRs de la réception de facture',
        typeEntetePaiement: dto.typeEntetePaiement || 'CONDITION',
        valeurEntetePaiement: dto.valeurEntetePaiement || dto.conditionPaiement || undefined,
  ...
  async updateVente(id: number, dto: UpdateFactureVenteDto) {
    ...
    const facture = await this.prisma.factureVente.update({
      ...
      data: {
        ...
        numeroBl: dto.numeroBl,
        delaiPaiement: dto.delaiPaiement,
        typeEntetePaiement: dto.typeEntetePaiement,
        valeurEntetePaiement: dto.valeurEntetePaiement,
        societe: dto.societe,
        chantier: dto.afficherChantier ? dto.chantier : null,
        afficherChantier: dto.afficherChantier ?? false,
        hasBl: dto.hasBl,
